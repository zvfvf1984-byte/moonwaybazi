  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-20 text-center">
      ...
      <div className="mt-10 grid sm:grid-cols-2 gap-4 max-w-lg mx-auto">
        <a href="mailto:hello@qiandcode.app" className="p-6 border border-gold/40 rounded-xl hover:bg-gold/10 transition">
        ...
        <a href="https://t.me/qiandcode" className="p-6 border border-gold/40 rounded-xl hover:bg-gold/10 transition">
      ...
      <Link to="/catalog" className="mt-12 inline-block px-8 py-4 bg-gold-gradient text-primary-foreground rounded-xl text-sm uppercase tracking-[0.2em] shadow-gold">
        Перейти в каталог
      </Link>
    </div>
  );
